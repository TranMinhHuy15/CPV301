...
CKPT_PATH   = os.path.join(OUTPUT_DIR, "best_adalea.pth")
BATCH_SIZE  = 8
NUM_WORKERS = 4
...
for lead_time in LEAD_TIMES:
    ...
    mauc01, recall01, thr01 = low_far_metrics(targets, scores)
...
print(f"\n{'='*65}")
print("  ADALEA BASELINE (cached, 5-frame) -- FINAL EVALUATION RESULTS (RQ1)")
print(f"{'='*65}")
...
results_path = os.path.join(OUTPUT_DIR, "eval_results_rq1_adalea.txt")
with open(results_path, "w") as f:
    f.write("AdaLEA Baseline (cached, 5-frame) - Evaluation Results (RQ1)\n")
