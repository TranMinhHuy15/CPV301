...
**Answer.**
- **Official test:** TOP and RiskProp both outperform AdaLEA, by about 0.04 mAP, and TOP and RiskProp cannot be separated.
...
Only the way AMC pairs are drawn differs. Random-offset uses gaps of 0.5–5.0 s (mean 2.75 s); FixedLag uses a constant gap τ. τ = 1.0 s is the main condition, and τ = 0.5 / 1.5 s are secondary sensitivity runs.
...
6. **Chi phí tiền thuê máy:** bổ sung số credit vast.ai đã dùng vào mục 5.6 nếu thầy yêu cầu báo cáo chi phí.
